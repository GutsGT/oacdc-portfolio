...
export default {
    ...
    theme: {
        extend: {
            ...
            backgroundImage: {},
            boxShadow: {
                'tech-image': "inset 0px 0px 10px 20px transparent"
            },
            fontFamily: {
                sans: ['Figtree', ...defaultTheme.fontFamily.sans],
                "trend-sans-one": "Trend Sans One Regular",
                "trend-sans-four": "Trend Sans W00 Four",
                "trend-sans-five": "Trend Sans W00 Five"
            },
            keyframes: {
                "typing": {
                    "from": {
